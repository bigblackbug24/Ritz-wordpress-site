...
<head>
  ...
  <title>About Us | Ritz Building Contracting Dubai</title>
  ...
  <!-- Flex Slider -->
  <link href="<?php bloginfo('stylesheet_directory'); ?>/css/flexslider.css" rel="stylesheet">
...
<body>
		...
		<div class="container">
			<div class="col-lg-12">
                ...
                <ul class="breadcrumb pull-right">
                    <li><a href="http://evisionsol.com/Ritz/home/">Home</a></li>
                    <li>About Us</li>
                </ul>
			</div>
		</div>
            	...
            	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="widget margin-top">
                        <div id="aboutslider" class="flexslider clearfix">
                            <ul class="slides">
                                <li><img src="<?php bloginfo('template_directory'); ?>/demos/about_mini_01.jpg" class="img-responsive" alt=""></li>
                                <li><img src="<?php bloginfo('template_directory'); ?>/demos/about_mini_02.jpg" class="img-responsive" alt=""></li>
                            </ul><!-- end slides -->
	...
	<section class="grey-wrapper jt-shadow">
    	<div class="container">
        	<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
            	<div class="widget">
                	<h3>WHY <span>RITZ</span> IS PROFESSIONAL & VERY COMPITENT?</h3>
                          ...
                          <div class="accordion-group">
                            <div class="accordion-heading">
                              <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">
                                <em class="fa fa-plus icon-fixed-width"></em>Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem.
                              </a>
                            </div>
	...
	<section class="white-wrapper jt-shadow">
    	<div class="container">
			<div class="calloutbox bggrey">
            	<div class="col-lg-10">
            	<h2>RITZ, you ever neededto build powerful & trendy Project!</h2>
                <p>Accusantium quam, ultricies eget tempor id, aliquam eget nibh et. Maecen aliquam, risus at semper.</p>
                </div>
                <div class="col-lg-2">
                <a class="btn pull-right btn-dark btn-lg margin-top" href="#">Ritz Profile</a>
                </div>
            </div><!-- end messagebox -->
		</div><!-- end container -->
  ...
  <script src="<?php bloginfo('stylesheet_directory'); ?>/js/jquery.parallax-1.1.3.js"></script>
  <script src="<?php bloginfo('stylesheet_directory'); ?>/js/jquery.simple-text-rotator.js"></script>
  ...
  <script src="<?php bloginfo('stylesheet_directory'); ?>/js/custom-portfolio.js"></script>

  <!-- SLIDER REVOLUTION 4.x SCRIPTS  -->
  <script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
  <script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
  ...
  <script src="<?php bloginfo('stylesheet_directory'); ?>/royalslider/jquery.easing-1.3.js"></script>
  <script src="<?php bloginfo('stylesheet_directory'); ?>/royalslider/jquery.royalslider.min.js"></script>
  <script>
	jQuery(document).ready(function($) {
