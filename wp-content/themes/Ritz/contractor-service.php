<?php /* Template Name: Contractor Service */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Contractor Service | Ritz Building Contracting Dubai</title>
            	...
            	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="widget margin-top">
                        <div id="aboutslider" class="flexslider clearfix">
                            <ul class="slides">
                                <li><img src="<?php bloginfo('template_directory'); ?>/demos/93.jpg" class="img-responsive" alt="Contractor Service"></li>
                                <li><img src="<?php bloginfo('template_directory'); ?>/demos/about_mini_02.jpg" class="img-responsive" alt="Contractor Service"></li>
                            </ul><!-- end slides -->
