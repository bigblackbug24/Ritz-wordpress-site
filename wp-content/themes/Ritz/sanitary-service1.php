<?php /*
Template Name: Sanitary Service
*/
get_header();
?>
<!DOCTYPE html>
...
<body>
  <section class="post-wrapper-top jt-shadow clearfix">
    <div class="container">
      <div class="col-lg-12">
        <h2>Sanitary Service</h2>
                <ul class="breadcrumb pull-right">
                    <li><a href="home">Home</a></li>
                    <li>Sanitary Service </li>
                </ul>
      </div>
    </div>
      ...
      <div class="container">
          <div class="row">
            ...
            <h3>Service Details</h3>
                            ...
                            <li><strong>Labour:</strong> Sanitary and Article decoration</li>
